    ...
    public function indexAction()
    {
        ...
        if ($this->_sessao["PerfilGeral"] == 'A') {
            ...
            if ($this->validarAcessoBeneficiadora($beneficiariaSimular, $sessao["idPessoa"])) {
                ...
                $sessao["operadora"] = '';
                $session->usuario = $sessao;
                parent::message('Benefici�ria n�o foi localizada!', '/minc/admin', 'error');
            }
        }
    ...
    public function atualizarDadosBeneficiariaAction()
    {
        ...
        if ($_POST) {
            ...
            if (count($logradouro) < 1 || strlen($NRCEP) != 8) {
                parent::message('CEP inv�lido', '/beneficiaria/index/dados-beneficiaria/', 'error');
            } else {
            ...
            if (!$IDTIPOLUCRO) {
                parent::message('Informe o tipo de tributa��o', '/beneficiaria/index/dados-beneficiaria/', 'error');
            }
...
//                $logradouro = $modelLogradouro->selectEndereco($whereLogradouro);
                ...
                if ($IDOPERADORAATUAL != $IDOPERADORA) {
                    ...
                    if ($this->_sessao["PerfilGeral"] != 'A') {
                        ...
                        $dadosSituacao = array(
                            ...
                            'DS_JUSTIFICATIVA' => 'Altera��o da Operadora.',
    ...
    public function emitircertificadoAction()
    {
        ...
        if ($idSituacao == ID_SITUACAO_AUTORIZADO) {
            ...
            // Dados do respons�vel da beneficiaria
                ...
                if ($_FILES[$k]['error'] == 0) {
                    ...
                    if (strpos($k, 'ANEXO') === false) {
                        ...
                        if (count($arquivoAtual) > 0) {
                            ...
                            parent::message('Sem permiss�o para substitui��o', '/beneficiaria/index/arquivos/', 'error');
                            return;
                        }
                    } else {
                        $acao = 'insert';
    ...
    public function salvarResponsavelAction()
    {
        ...
        // Validando Form
        if ($IDPF == '0') {
            parent::message('CPF n�o encontrado!', '/beneficiaria/index/novo-responsavel', 'error');
        }
        ...
        if (!validaEmail($DSEMAIL)) {
            parent::message('Email inv�lido!', '/beneficiaria/index/novo-responsavel', 'error');
        }
        ...
        try {
            ...
            $db->commit();
            parent::message('Respons�vel cadastrado com sucesso!', '/beneficiaria/index/responsavel', 'confirm');

        } catch (Exception $exc) {
            $db->rollBack();
            parent::message('Erro ao cadastrar o respons�vel.', '/beneficiaria/index/novo-responsavel', 'error');
        }
    ...
    public function editarResponsavelAction()
    {
        ...
        if (count($responsavel) > 0) {
            ...
            parent::message('Erro ao localizar o respons�vel.', '/beneficiaria/index/responsavel', 'error');
        }
        ...
        try {
            ...
            if ($fone) {
                ...
                if (count($existeFone) == 0) {
                    ...
                    parent::message($this->getRequest()->getParam('TelResponsavel') . '  j� est� cadastrado!', 'beneficiaria/index/editar-responsavel/id/' . $idResponsavel, 'error');
                }
            }
    ...
    public function delTelefoneResponsavelAction()
    {
        ...
        try {
            ...
            parent::message('Telefone exclu�do com sucesso!', 'beneficiaria/index/editar-responsavel/id/' . $idResponsavel, 'confirm');
    ...
    public function addEmailResponsavelAction()
    {
        ...
        if (!validaEmail($email)) {
            parent::message('E-mail inv�lido!', 'beneficiaria/index/editar-responsavel/id/' . $idResponsavel, 'error');
        }
        ...
        try {
            ...
            if ($email) {
                ...
                if (count($existeEmail) == 0) {
                    ...
                    parent::message($email . '  j� est� cadastrado!', 'beneficiaria/index/editar-responsavel/id/' . $idResponsavel, 'error');
                }
    ...
    public function delEmailResponsavelAction()
    {
        ...
        try {
            ...
            parent::message('Email exclu�do com sucesso!', 'beneficiaria/index/editar-responsavel/id/' . $idResponsavel, 'confirm');
        ...
        try {
            ...
            if ($atualiza) {
                ...
                if ($this->_sessao["PerfilGeral"] != 'A') {
                    ...
                    $dadosSituacao = array(
                        'ID_PESSOA' => $idBeneficiaria,
                        'DS_JUSTIFICATIVA' => 'Altera��o das faixas salariais.',
                        'ID_USUARIO' => $this->_sessao['idUsuario'],
                        'TP_ENTIDADE_VALE_CULTURA' => 'B',
                        'ID_TIPO_SITUACAO' => 1
                    );
    ...
    public function alterarsenhaactionAction()
    {
        if ($_POST) {
            ...
            if ($NOVA_SENHA != $NOVA_SENHA_CONFIRMA) {
                parent::message('Senha de confirmação incorreta', '/beneficiaria/index/alterarsenha/', 'error');
            }
    ...
    public function ativacaoResponsavelAction()
    {
        ...
        try {
            ...
            parent::message('Ops, desculpe mas houve um erro na aplica��o.', '/beneficiaria/index/responsavel/', 'error');
        }
    }
    ...
    public function ativacaoNaoResponsavelAction()
    {
        ...
        try {
            ...
            parent::message('Ops, desculpe mas houve um erro na aplica��o.', '/beneficiaria/index/nao-responsavel/', 'error');
        }
    }
    ...
    public function autorizarDivulgacaoMincAction()
    {
        ...
        if ($this->validarAcessoBeneficiadora($idBeneficiaria, $this->_sessao['idPessoa'])) {
            ...
            if ($autorizacao === "AUTORIZO") {
                ...
                parent::message('Atualiza��o realizada com sucesso!', '/minc/admin', 'confirm');
            } else if ($autorizacao === "N�O AUTORIZO") {
                $Cols = array(
                    'ST_AUTORIZA_MINC' => 2
                );

                $modelBeneficiaria->update($Cols, $idBeneficiaria);
                parent::message('Divulga��o n�o autorizada!', '/minc/admin', 'confirm');
            }
        } else {
            parent::message('Benefici�ria n�o foi localizada!', '/minc/admin', 'error');
        }
...
//                $enviarEmail = $modelEmail->enviarEmail($DSEMAIL, 'Acesso ao sistema Vale Cultura', $htmlEmail);
            ...
            $db->commit();
            parent::message('N�o Respons�vel cadastrado com sucesso!', '/beneficiaria/index/nao-responsavel', 'confirm');
